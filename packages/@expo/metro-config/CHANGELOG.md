...
- Collapse `expo`, `expo-router`, and `@expo/log-box` dev-console stack frames when they resolve outside `node_modules` (monorepos, linked workspaces), matching what apps see. (by [@ramonclaudio](https://github.com/ramonclaudio))
