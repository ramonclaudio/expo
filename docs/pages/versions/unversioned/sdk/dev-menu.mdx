...
In SDK 55 and later, `expo-dev-menu` can be used as a **standalone library** in any Expo project. It is especially useful in brownfield apps that don't need the full `expo-dev-client` launcher interface.
...
- Support for loading updates from EAS
